    ...
    def __init__(self,
        ...
        if self.decoder_mode == 'mirror':
            ...
            if self.decoder_head:
                self.decoder_out = nn.Conv1d(in_channels, in_channels, kernel_size=1, padding=self.conv_padding)
            ...
            self.decoder_out = nn.Conv1d(out_f, in_channels, kernel_size=1, padding=self.conv_padding)
