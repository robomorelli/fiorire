...
# ============================================================================
# Launch wrapper for PBS fine-tuning jobs
# ============================================================================
# Usage:
#   sh launch_wrapper_ft.sh \
#       num_nodes 2 \
#       num_gpus 1 \
#       num_cpus 16 \
...
PBS_JOB="/davinci-1/home/morellir/artificial_intelligence/repos/fiorire/pbs_jobs/launch_hpo_ft_${CONFIG_FILE}_${TIMESTAMP}.pbs"
...
cat > "$PBS_JOB" <<EOF
#!/bin/bash
#PBS -N fiorire_ft_${CONFIG_FILE}
#PBS -o fiorire_ft_${CONFIG_FILE}_${TIMESTAMP}.log
#PBS -e fiorire_ft_${CONFIG_FILE}_${TIMESTAMP}.err
#PBS -q gpu
#PBS -k oe
#PBS -m e
...
echo ""
echo "="*80
echo "🚀 SUBMITTING PBS JOB (FINE-TUNING)"
echo "="*80
echo ""
