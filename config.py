...
config_path = root + '/train_configurations/'  # ← Path per i config YAML
...
all_feats_dict = {
    'fiorire_1': ['RW1_motcurr', 'RW2_motcurr', 'RW3_motcurr', 'RW4_motcurr',
...
fiorire_family = ['fiorire_1', 'fiorire_2']
fiorire_1_data_path = root + '/data/fiorire_1/all_2016-2018_clean_4s.pkl'
fiorire_2_data_path = root + '/data/fiorire_2/nominal_merged.csv'
