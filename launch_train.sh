...
#qsub -v entity=robmorelli,data_cfg=filtered_data,hyp_cfg=hyp,sweep_cfg=sweep,NUM_GPUS=4 artificial_intelligence/repos/fuselage_defects_detection/run_batch_hyp.sh